...
public class SlideDAO {
    ...
    public void InsertSlides(SlideObject slideObject){
        String sql = "INSERT INTO SLIDES_PDF (SLIDE_TITLE,SLIDE_LINK,COURSE_ID) VALUES (?,?,?)";
        jdbcTemplate.update(sql,slideObject.getSlide_title(),slideObject.getSlide_link(),slideObject.getCourse_id());
    }

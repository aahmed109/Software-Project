...
<html>
<head>
    <title>Department of Urban and Regional Planning</title>
    <meta charset="utf-8">
    ...
    <div id="main">
        ...
        <header style="margin-left: 10%">
            <div class="wrapper">
                <div class="wrapper">
                    <h1 id = "logo"></h1>
                    <h1 style="font-family: Lucida Bright,serif; color: white; font-size: 40px">URBAN AND REGIONAL PLANNING</h1>
                    <div id="slogan"></div>
                </div>
            </div>
        </header>

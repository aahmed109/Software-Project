                            ...
                            <form id="signInForm" action="${pageContext.request.contextPath}/login.html" method="post">
                                <div>
                                    <div class="wrapper">
                                        ...
                                        <input name="uid" type="text" class="input" value="1" style="background: #fff; border: 1px solid #e5e5e5; border-radius:6px; -moz-border-radius:6px; -webkit-border-radius:6px; position:relative">
                                    </div>

                                    <div class="wrapper">
                                        <label><strong>Password:</strong></label>
                                        <input name="pass" type="password" class="input" value="akibthemew" style="background: #fff; border: 1px solid #e5e5e5; border-radius:6px; -moz-border-radius:6px; -webkit-border-radius:6px; position:relative">
                                    </div>

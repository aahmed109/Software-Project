                                ...
                                <form id="signUpForm" action="${pageContext.request.contextPath}/signup.html" method="post">
                                    <div>
                                        ...
                                        <div class="wrapper">
                                            ...
                                            <input name="mail" type="text" class="input" value="Anisha" style="background: #fff; border: 1px solid #e5e5e5; border-radius:6px; -moz-border-radius:6px; -webkit-border-radius:6px; position:relative">
                                        </div>

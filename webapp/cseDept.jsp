    ...
    <div id="main">
        ...
        <header style="margin-left: 10%">
            <div class="wrapper">
                <div class="wrapper">
                    <h1 id = "logo"></h1>
                    <h1 style="font-family: Lucida Bright,serif; color: white; font-size: 40px">COMPUTER SCIENCE AND ENGINEERING</h1>
                    <div id="slogan"></div>
                </div>
            </div>
        </header>
                ...
                <div class="wrapper">
                    <article class="col2 pad_left2">
                        ...
                        <ul class="list1 pad_bot1">
                            ...
                            <li><a href="#">Object Oriented Programming Language</a></li>

...
public class CourseDAO {
    ...
    public void InsertCourse(CourseObject courseObject){
        String sql = "INSERT INTO COURSE (COURSE_ID,COURSE_NAME,DEPARTMENT_ID,TEACHER_ID,ABOUT_COURSE) VALUES (?,?,?,?,?)";
        jdbcTemplate.update(sql,courseObject.getCourse_id(),courseObject.getCourse_name(),courseObject.getDepartment_id(),courseObject.getTeacher_id(),courseObject.getAbout_course());
    }

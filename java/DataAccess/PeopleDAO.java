...
public class PeopleDAO{
    ...
    public void Insert(PeopleObject peopleObject) {
        ...
        String  sql2 = "INSERT INTO PEOPLE (USER_NAME, USER_ID, EMAIL, PASSWORDS, INSTITUTION, PROFESSION, GENDER, COUNTRY, DISTRICT, DIVISION, ROAD_NO, HOUSE_NO, CONTACT_NO, DOB, JOIN_DATE ) "
                    + " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        jdbcTemplate.update(sql2,peopleObject.getUser_name(),peopleObject.getUser_id(),peopleObject.getEmail(),peopleObject.getPassword(), peopleObject.getInstitution(),
